...
def run_experiment(args):
    ...
    command = ['python train.py {} --arch delight_transformer_wmt16_en_ro '
               ...
               '--device-id 0 '
               '--no-progress-bar '
               '--optimizer adam --adam-betas \'(0.9, 0.98)\' --clip-norm 0.0 --weight-decay 0.0 ' #initial weiht-decaty era 0.0 | 0.0001
               ...
               '--save-dir {} '
               # '--fp16 '
               # '--eval-bleu --eval-bleu-print-samples --eval-bleu-remove-bpe --eval-bleu-detok moses --best-checkpoint-metric bleu '
               ...
               '--delight-dec-min-depth 4 --delight-dec-max-depth 4 --delight-dec-width-mult 2 '
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('Training script for WMT14 En2Ro')
    parser.add_argument('--d-m', type=int, default=128, help='Model dimension')
    parser.add_argument('--data-dir', type=str, default='/home/george/Desktop/Machine_Translation_En_Ro/delight-master/data-bin/wmt16_en_ro_fast_573sub_paragr_4newdatasets/', help='Data location')
    parser.add_argument('--tensorboard-logdir', type=str, default='/home/george/Desktop/Machine_Translation_En_Ro/delight-master/tensorboard/', help='Tensorboard location')
    ...
    parser.add_argument('--update-freq', type=int, default=8, help='update freq')
    parser.add_argument('--num-gpus', type=int, default=1, help='num. of GPUs')
    parser.add_argument('--save-dir', type=str, default='./results_fast_573sub_paragr_4newdatasets_wmt16_8-upd-freq_100k-upd_4096-tok', help='Results directory')
